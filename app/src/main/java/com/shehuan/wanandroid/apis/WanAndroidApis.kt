...
interface WanAndroidApis {
    ...
    /**
     * 首页文章列表  https://www.wanandroid.com/article/list/{pageNum}/json
     */
     ...
     */
    @GET("article/list/{pageNum}/json")
    suspend fun treeDetail(
        @Path("pageNum") pageNum: Int,
        @Query("cid") cid: Int
    ): BaseResponse<TreeDetailBean>
    ...
    suspend fun chapterArticleList(
    ...
    suspend fun cancelMyCollection(
        @Path("id") id: Int,
